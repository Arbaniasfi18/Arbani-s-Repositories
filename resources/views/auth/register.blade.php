            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="no_telp" class="col-md-4 col-form-label text-md-end">{{ __('Nomor Telpon Aktif (whatsapp)') }}</label>
                        
                            <div class="col-md-6">
                                <input id="no_telp" type="text" class="form-control @error('no_telp') is-invalid @enderror" name="no_telp"
                                    value="{{ old('no_telp') }}" required autocomplete="false" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="tanggal_lahir" type="date" class="form-control @error('tanggal_lahir') is-invalid @enderror" name="tanggal_lahir"
                                    value="{{ old('tanggal_lahir') }}" required autocomplete="false" autofocus>
                        ...
                        <div class="row mb-3">
                            <label for="no_identitas" class="col-md-4 col-form-label text-md-end">{{ __('Nomor Identitas (KTP/KTM)') }}</label>
                        
                            <div class="col-md-6">
                                <input id="no_identitas" type="text" class="form-control @error('no_identitas') is-invalid @enderror"
                                    name="no_identitas" value="{{ old('no_identitas') }}" required autocomplete="false" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="universitas" type="text" class="form-control @error('universitas') is-invalid @enderror"
                                    name="universitas" value="{{ old('universitas') }}" required autocomplete="false" autofocus>
